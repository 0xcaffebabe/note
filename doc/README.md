...
- [🍚中间件](./中间件/nav.md)
  - [💾数据库](./中间件/数据库/数据库系统/关系数据库/引言.md)
    ...
    - [数据库设计和ER模型](./中间件/数据库/数据库系统/数据库设计/数据库设计和ER模型.md)
    - [关系数据库设计](./中间件/数据库/数据库系统/数据库设计/关系数据库设计.md)
    ...
    - [并发控制](./中间件/数据库/数据库系统/事务管理/并发控制.md)
