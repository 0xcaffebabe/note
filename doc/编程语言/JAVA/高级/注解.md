...
- [/编程语言/JAVA/编译原理.md](/编程语言/JAVA/编译原理.md) 注解处理器（APT）在编译期间处理注解，Java编译器对注解的处理是理解注解生命周期的关键环节
...
- [/编程语言/JAVA/框架/Dubbo.md](/编程语言/JAVA/框架/Dubbo.md) Dubbo框架使用@Service等注解进行服务暴露和引用，是分布式系统中注解的重要应用
...
- [/中间件/消息队列/rabbitMQ.md](/中间件/消息队列/rabbitMQ.md) 消息队列框架使用注解简化消息监听和发送的配置
