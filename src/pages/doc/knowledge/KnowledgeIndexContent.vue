<template>
  <div class="knowledge-index-content">
    <div class="knowledge-index-toolbar">
      ...
      />
      <el-button @click="$emit('close')" class="close-btn" plain>
...
import { ElTree, ElInput, ElButton, ElIcon, ElEmpty } from "element-plus";
      ...
      if (target.tagName === 'A') {
        ...
        if (href) {
          ...
          if (href.startsWith('#')) {
            ...
            // this.$emit('navigate', target.getAttribute('origin-link'));
          }
        }
      }
    }
