...
import { adjacentByDocId } from '@/core/util/CategoryUtils'
...
export default defineComponent({
  ...
  computed: {
    prev(): Category | null {
      return adjacentByDocId(this.orderedList, this.doc).prev
    },
    next(): Category | null {
      return adjacentByDocId(this.orderedList, this.doc).next
    },
  },
  methods: {
  ...
  async created() {
    this.orderedList = await this.$services.categoryService.getOrderedDocList()
  },
})
</script>
