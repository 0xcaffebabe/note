...
- [/计算机网络/http/HTTP.md](/计算机网络/http/HTTP.md) Cookie 与 Session 是 HTTP 协议状态管理机制的核心实现，直接依托 HTTP 请求响应模型
- [/计算机网络/网络安全/认证与授权.md](/计算机网络/网络安全/认证与授权.md) Session 是传统 Web 认证的核心机制，与 Token/JWT 的演进共同构成认证授权体系
- [/计算机网络/网络安全/Web安全.md](/计算机网络/网络安全/Web安全.md) Cookie 的安全属性（HttpOnly、SameSite）与 CSRF、XSS 等 Web 攻击防护密切相关
- [/计算机网络/网络安全/安全架构.md](/计算机网络/网络安全/安全架构.md) 文档中的信任分层模型（客户端低信任层 vs 服务端高信任层）是安全架构设计的典型范式
- [/软件工程/架构/系统设计/缓存.md](/软件工程/架构/系统设计/缓存.md) Cookie/Session 的冷热数据分层设计与通用缓存架构原理高度一致
- [/软件工程/架构/系统设计/分布式/分布式系统.md](/软件工程/架构/系统设计/分布式/分布式系统.md) 分布式 Session 与状态外置化是分布式系统无粘性负载均衡的关键设计
- [/中间件/数据库/redis/Redis.md](/中间件/数据库/redis/Redis.md) Redis 是分布式 Session 存储的主流方案，实现会话状态的集中管理与共享
- [/软件工程/架构/系统设计/网关.md](/软件工程/架构/系统设计/网关.md) 网关层承担 Session/Token 认证鉴权的统一处理，是信任边界的执行点
